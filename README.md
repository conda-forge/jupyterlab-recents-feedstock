...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jupyterlab-recents-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12254&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jupyterlab-recents-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jupyterlab-recents` can be installed with:

```
conda install jupyterlab-recents
```

It is possible to list all of the versions of `jupyterlab-recents` available on your platform with:
